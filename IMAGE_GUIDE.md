...
|-----|-----------|------|--------|-------------|
| 1 | `hero-poster.jpg` | 動画が読み込まれる前に表示される静止画 | 1920x1080px | **16:9（横長）** |
| 2 | `concept-1.jpg` | 施術シーン（眉毛デザイン中の手元） | 800x1000px | **4:5（縦長）** |
| 3 | `concept-2.jpg` | サロン内観（半個室の雰囲気） | 600x400px | **3:2（横長）** |
| 4 | `visual-break.jpg` | 施術後の目元クローズアップ | 1600x600px | **8:3（超横長）** |
| 5 | `gallery-1.jpg` | パリジェンヌ Before/After | 600x800px | **3:4（縦長）** |
| 6 | `gallery-2.jpg` | 眉毛WAX Before/After | 400x400px | **1:1（正方形）** |
| 7 | `gallery-3.jpg` | ハリウッドブロウリフト 仕上がり | 400x400px | **1:1（正方形）** |
| 8 | `gallery-4.jpg` | セットメニュー Before/After | 400x400px | **1:1（正方形）** |
| 9 | `gallery-5.jpg` | メンズ眉毛 Before/After | 400x400px | **1:1（正方形）** |
| 12 | `cta-bg.jpg` | 最終CTA背景（暗め・抽象的） | 1920x1080px | **16:9（横長）** |
...
### 1. hero-poster.jpg / hero-video.mp4
- **アスペクト比**: 16:9
...
### 6-9. gallery-2.jpg ～ gallery-5.jpg
- **アスペクト比**: 1:1（正方形）
- **推奨サイズ**: 400 x 400 px
- **用途**: ギャラリーグリッド画像
